...
class Categories:
    CATEGORIES = {
        "Heroes": {ID.Hero, ID.Prison, ID.Random_Hero, ID.Hero_Placeholder},
        "Towns": {ID.Town, ID.Random_Town},
        "Monsters": {
            ID.Monster,
            ID.Random_Monster,
            ID.Random_Monster_1,
        ...
        "Artifacts": {
            ID.Artifact,
            ID.Random_Artifact,
            ID.Random_Treasure_Artifact,
            ID.Random_Minor_Artifact,
            ID.Random_Major_Artifact,
            ID.Random_Relic,
        },
        "Resources": {ID.Resource, ID.Random_Resource},
        ...
        "Creature Banks": {ID.Creature_Bank, ID.Derelict_Ship, ID.Dragon_Utopia, ID.Crypt, ID.Shipwreck},
        "Garrisons": {ID.Garrison, ID.Garrison_Vertical},
        "Seer's Hut": {ID.Seers_Hut},
        "Quest Objects": {ID.Quest_Guard},
        "Event Objects": {ID.Event, ID.Pandoras_Box},
        "Border Objects": {ID.Border_Guard, ID.Keymasters_Tent},
        "Dwellings": {
            ID.Creature_Generator_1,
            ID.Creature_Generator_4,
            ID.Random_Dwelling,
            ID.Random_Dwelling_Leveled,
            ID.Random_Dwelling_Faction,
        },
        "Mines & Warehouses": {ID.Mine, ID.HotA_Warehouse, ID.Abandoned_Mine},
        "Interactive": {ID.University, ID.Witch_Hut, ID.Black_Market, ID.HotA_Visitable_1, ID.HotA_Visitable_2},
        "Simple Objects": {ID.Tree_of_Knowledge, ID.Lean_To, ID.Wagon, ID.Warriors_Tomb, ID.Lighthouse, ID.Shipyard},
        "Text": {ID.Sign, ID.Ocean_Bottle},
        "Decor": Decor.IDS,
    }
...
class ZoneInfo:
    INFO = {
        (77, 77, 77): ("Normal", "Normal"),  # gray land
        (80, 85, 88): ("Normal", "Normal"),  # gray water
        (89, 110, 184): ("Player", "Blue"),  # blue
        (129, 108, 88): ("Player", "Tan"),  # tan
        (71, 109, 54): ("Player", "Green"),  # green
        (179, 129, 76): ("Player", "Orange"),  # orange
