...
def draw_header() -> None:
    ...
    header_appname = get_header_line(fill_color=(Color.FAINT + Color.GREY), fill="#", text=App.NAME)
    header_version = get_header_line(fill_color=(Color.FAINT + Color.GREY), fill="#", text=App.VERSION)
