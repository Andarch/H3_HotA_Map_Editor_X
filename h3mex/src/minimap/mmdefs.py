...
class ObjectRGB:
    ...
    monolith_portal = {
        objects.SubID.Portal.OneWay.Small_Blue: (0x1E, 0x40, 0xCF),
        objects.SubID.Portal.OneWay.Small_Pink: (0xF7, 0x38, 0xA6),
        objects.SubID.Portal.OneWay.Small_Orange: (0xFF, 0x8C, 0x1A),
        objects.SubID.Portal.OneWay.Small_Yellow: (0xFF, 0xF7, 0x1A),
        objects.SubID.Portal.OneWay.Big_Purple: (0x8E, 0x44, 0xAD),
        objects.SubID.Portal.OneWay.Big_Orange: (0xFF, 0xB3, 0x47),
        objects.SubID.Portal.OneWay.Big_Red: (0xE7, 0x2B, 0x2B),
        objects.SubID.Portal.OneWay.Big_Cyan: (0x1A, 0xE6, 0xE6),
        objects.SubID.Portal.OneWay.Small_Turquoise: (0x1A, 0xC6, 0xB7),
        objects.SubID.Portal.OneWay.Small_Violet: (0x7C, 0x3C, 0xBD),
        objects.SubID.Portal.OneWay.Small_Chartreuse: (0x7D, 0xFF, 0x1A),
        objects.SubID.Portal.OneWay.Small_White: (0xF7, 0xF7, 0xF7),
        objects.SubID.Portal.TwoWay.Small_Green: (0x1A, 0xB5, 0x3B),
        objects.SubID.Portal.TwoWay.Small_Brown: (0x8B, 0x5C, 0x2B),
        objects.SubID.Portal.TwoWay.Small_Violet: (0xB0, 0x5D, 0xE6),
        objects.SubID.Portal.TwoWay.Small_Orange: (0xFF, 0x6F, 0x00),
        objects.SubID.Portal.TwoWay.Big_Green: (0x3B, 0xE6, 0x1A),
        objects.SubID.Portal.TwoWay.Big_Yellow: (0xFF, 0xE6, 0x1A),
        objects.SubID.Portal.TwoWay.Big_Red: (0xD9, 0x2B, 0x2B),
        objects.SubID.Portal.TwoWay.Big_Cyan: (0x1A, 0xB5, 0xE6),
        objects.SubID.Portal.TwoWay.Water_White: (0xFF, 0xFF, 0xFF),
        objects.SubID.Portal.TwoWay.Small_Pink: (0xFF, 0x69, 0xB4),
        objects.SubID.Portal.TwoWay.Small_Turquoise: (0x40, 0xE0, 0xD0),
        objects.SubID.Portal.TwoWay.Small_Yellow: (0xFF, 0xFF, 0x99),
        objects.SubID.Portal.TwoWay.Small_Black: (0x22, 0x22, 0x22),
        objects.SubID.Portal.TwoWay.Big_Chartreuse: (0x7F, 0xFF, 0x00),
        objects.SubID.Portal.TwoWay.Big_Turquoise: (0x00, 0xFF, 0xFF),
        objects.SubID.Portal.TwoWay.Big_Violet: (0xEE, 0x82, 0xEE),
        objects.SubID.Portal.TwoWay.Big_Orange: (0xFF, 0xA5, 0x00),
        objects.SubID.Portal.TwoWay.Small_Blue: (0x00, 0x7F, 0xFF),
        objects.SubID.Portal.TwoWay.Small_Red: (0xFF, 0x45, 0x00),
        objects.SubID.Portal.TwoWay.Big_Pink: (0xFF, 0xC0, 0xCB),
        objects.SubID.Portal.TwoWay.Big_Blue: (0x00, 0x00, 0xFF),
        objects.SubID.Portal.TwoWay.Water_Red: (0xB2, 0x22, 0x22),
        objects.SubID.Portal.TwoWay.Water_Blue: (0x41, 0x69, 0xE1),
        objects.SubID.Portal.TwoWay.Water_Chartreuse: (0xAD, 0xFF, 0x2F),
        objects.SubID.Portal.TwoWay.Water_Yellow: (0xFF, 0xFA, 0xCD),
    }
